...
function BurgerShotMint() {
  ...
  <p className="text-[10px] uppercase tracking-[0.2em] mb-1" style={{ fontFamily: "'Space Mono', monospace", color: th.mutedtext, opacity: 0.6 }}>
    COMMUNITY
  </p>
  
  {/* Twitter / X */}
  <a href="https://x.com/Elvan_Adi28" target="_blank" rel="noreferrer" className="flex items-center gap-2.5 group transition-all duration-300 no-underline">
    <svg className="w-3.5 h-3.5 transition-all duration-300 group-hover:scale-110 group-hover:text-white" viewBox="0 0 24 24" fill="currentColor" style={{ color: th.mutedtext }}>
      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
    </svg>
    <span className="text-[10px] transition-all duration-300 group-hover:text-white" style={{ fontFamily: "'Space Mono', monospace", color: th.mutedtext }}>
      TWITTER / X
    </span>
  </a>

  {/* Github / Source Code */}
  <a href="https://github.com/alfa76519-art/burger-shot-opnet-v2" target="_blank" rel="noreferrer" className="flex items-center gap-2.5 group transition-all duration-300 no-underline">
    <svg className="w-3.5 h-3.5 transition-all duration-300 group-hover:scale-110 group-hover:text-white" viewBox="0 0 24 24" fill="currentColor" style={{ color: th.mutedtext }}>
